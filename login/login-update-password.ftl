                        ...
                        <div class="col-md-5 pr-3">
                            <div class="mb-5 pb-1 pt-1 bg-white rounded shadow-lg">
                                <form class="m-5" id="kc-reset-password-form" action="${url.loginAction}" method="post" autocomplete="off">
                                    ...
                                    <h3 class="pb-3">${msg("updatePasswordTitle")}</h3>
    <#elseif section = "form-end">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input tabindex="1" id="password-new" name="password-new" class="form-control border-right-0" type="password" placeholder="${msg("passwordNew")}" autofocus autocomplete="off"/>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input tabindex="2" id="password-confirm" name="password-confirm" class="form-control border-right-0" type="password" placeholder="${msg("passwordConfirm")}" autofocus autocomplete="off"/>
                                    ...
                                    <div class="form-group">
                                        <#if isAppInitiatedAction??>
                                            <input tabindex="3" class="btn btn-primary btn-block" type="submit" value="${msg("doSubmit")}" />
